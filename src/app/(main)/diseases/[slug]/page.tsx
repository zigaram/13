...
import { buildBreadcrumbs, getDiseaseRelatedLinks, getRelatedDiseases } from '@/lib/links';
...
export default async function DiseasePage({ params }: Props) {
  ...
  const relatedLinks = getDiseaseRelatedLinks(disease);
  const relatedDiseases = await getRelatedDiseases(disease, 4);
